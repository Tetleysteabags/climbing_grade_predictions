...
bouldering_model_url = "https://github.com/Tetleysteabags/climbing_ml_project/raw/main/best_model_gb_bouldering.pkl"
bouldering_scaler_url = "https://github.com/Tetleysteabags/climbing_ml_project/raw/main/scaler_gb_bouldering.pkl"
...
sport_scaler_url = "https://github.com/Tetleysteabags/climbing_ml_project/raw/main/scaler_rf_sport.pkl"
...
with st.sidebar.form(key='my_form'):
    ...
    max_pullups = st.sidebar.number_input("Max pullups in single go", min_value=0, max_value=50, value=10, step=1, key="max_pullups")
    ...
    submit_button = st.form_submit_button(label='Submit metrics')
...
if submit_button:
    ...
    def bouldering_input_features(strength_to_weight_pullup, strength_to_weight_maxhang, strength_to_weight_weightpull,repeaters, exp, days):
        data_bouldering = {
            "strength_to_weight_pullup": strength_to_weight_pullup,
            "strength_to_weight_maxhang": strength_to_weight_maxhang,
            "strength_to_weight_weightpull": strength_to_weight_weightpull,
